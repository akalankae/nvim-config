-- -- configuration
-- local config = {
--   projectsFolder = "/home/akalanka/Documents/notes", --full path without ~
--   maxDepth = 3,
...
-- end
--
-- -- function to update g:vimwiki_list config item from list of subfolder names
-- -- (append project wikis) this way, original <Leader>ws will get new project
-- -- wikis in the list and also keep ones from config
